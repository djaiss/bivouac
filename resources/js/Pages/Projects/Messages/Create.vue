...
<template>
  ...
  <AuthenticatedLayout>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              <li>
                <div class="flex items-center">
                  <Link :href="data.url.breadcrumb.projects"
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <Link :href="data.url.breadcrumb.project"
                      class="text-sm text-blue-700 hover:bg-blue-700 hover:text-white hover:rounded-sm underline">{{
                    data.project.name }}
                  </Link>
                </div>
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <span class="ml-1 text-sm text-gray-500 md:ml-2 dark:text-gray-400">{{ $t('Create a message') }}</span>
                </div>
              </li>
            </ol>
          </nav>
    ...
    <div class="pb-12">
      <div class="mx-auto max-w-6xl bg-white dark:bg-gray-800 shadow-md overflow-hidden rounded-lg">
        <form @submit.prevent="submit">
          ...
          <div class="px-6 py-4 relative border-b">
            ...
            <!-- Description -->
            <div class="mb-4">
              <InputLabel for="description" :value="$t('Provide a description for this project.')" :required="false"
                class="mb-1" />
          ...
          <div class="px-6 py-4 space-y-2">
            <div class="flex items-center gap-x-2">
              <input id="hidden" v-model="form.is_public" value="true" name="public" type="radio"
            ...
            <div class="flex items-center gap-x-2">
              <input id="month_day" v-model="form.is_public" value="false" name="public" type="radio"
                class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" />
          ...
          <div class="border-t flex items-center justify-between px-6 py-4 bg-gray-50">
            <Link :href="data.url.breadcrumb.users"
