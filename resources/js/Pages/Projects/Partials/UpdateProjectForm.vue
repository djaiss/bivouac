  ...
  <section>
    ...
    <div class="flex">
      ...
      <div class="mr-8 w-96 p-4 text-sm">
        {{ $t("A project title is a concise phrase that identifies a project, providing a brief overview of its subject or purpose. A project description expands on the title and provides a more detailed explanation of the project's goals, objectives, scope, and expected outcomes.") }}
      </div>
      ...
      <div class="w-full p-4">
        ...
        <form @submit.prevent="update" class="max-w-5xl space-y-4">
          ...
          <!-- short description -->
          <div>
            <InputLabel for="short_description" :value="$t('Summarize the project in one line.')" class="mb-1" :required="false" />
