...
namespace Tests\Unit\Controllers\Projects\Summary;

use App\Http\Controllers\Projects\Summary\ProjectUpdateViewModel;
...
class ProjectUpdateViewModelTest extends TestCase
{
    ...
    public function it_gets_the_data_needed_for_the_index_view(): void
    {
        ...
        $array = ProjectUpdateViewModel::index($project);
        ...
        $this->assertEquals(
            [
                'store' => env('APP_URL') . '/projects/' . $project->id . '/updates',
            ],
            $array['url']
        );
    }
    ...
    public function it_gets_the_dto(): void
    {
        ...
        $array = ProjectUpdateViewModel::dto($update);
