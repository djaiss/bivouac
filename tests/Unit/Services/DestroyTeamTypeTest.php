...
class DestroyTeamTypeTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_destroys_a_team_type(): void
    {
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new DestroyTeamType)->execute($request);
    }
    ...
    private function executeService(User $user, TeamType $teamType): void
    {
        ...
        $this->assertDatabaseMissing('team_types', [
            'id' => $teamType->id,
        ]);
    }
}
